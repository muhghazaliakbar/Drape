        ...
        Form {
            ...
            Section {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    Text("Free and MIT licensed, and it stays that way. If PresentSafe has saved you from sharing something you would rather not have, you are welcome to say thanks.")
